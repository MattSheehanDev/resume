    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{User Experience}
          {Led the client-side design and development for the company's flagship cloud imaging software (\footnotesize{XVWeb}). Controlled the entire user experience for all customers.}
