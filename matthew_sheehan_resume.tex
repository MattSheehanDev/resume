    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Cloud Architecture}
          {ollaborated on designing a secure cloud-native architecture for moving flagship Denticon Practice Management product lines from on-premises to Azure and migrating Apteryx Imaging product lines to an enterprise-scale Azure architecture.}
