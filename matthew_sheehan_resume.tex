...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://mattsheehan.dev/}{\Large Matthew Sheehan}} & Email: \href{mailto:matt-sheehan@outlook.com}{matt-sheehan@outlook.com}\\
  \href{https://mattsheehan.dev/}{https://mattsheehan.dev} & Mobile: 330-614-1599 \\
  \href{https://www.linkedin.com/in/matt-sheehan-dev/}{linkedin.com/in/matt-sheehan-dev} & \\
\end{tabular*}


%-----------SUMMARY-----------------
\section{Summary}
Software Engineering Manager with 12+ years of experience building cloud-native applications and leading cross-functional teams. Expertise in Azure architecture, DevOps practices, and enterprise-scale system design. Proven track record of delivering high-availability solutions and mentoring engineering teams.
...
\section{Experience}
  ...
  \resumeSubheadingPosition{Software Engineering Manager}{Dec 2024 - Present}
    \resumeItemListStart
      \resumeItem{Integrated Payments}
        {Led the integration of Planet DDS Pay, our integrated payments platform, into the flagship practice management software, generating millions of dollars in payments revenue.}
      \resumeItem{Revenue Cycle Management Teams}
        {Led 3 revenue cycle management teams totaling 18 developers and QA engineers, including both onshore employees and offshore contractors.}
    \resumeItemListEnd

  \resumeSubheadingPosition{Staff Software Engineer}{Feb 2023 - Dec 2024}
    \resumeItemListStart
      \resumeItem{Patient Engagement Platform}
        {Architected and led a team of 3 onshore and 5 offshore developers to build a cloud native enterprise grade patient engagement system with a focus on high scalability to exceed our target throughput of 1 million customized SMS and Email messages per day.}
      \resumeItem{Tiger Team}
        {Led a cross-functional team of 7 developers and 1 infrastructure engineer to tackle mission critical stability and reliability concerns following several major incidents affecting our flagship practice management software. After our work we were able to exceed our 99.5\% uptime SLA.}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Certification Number: 6B48FN-55DF52}{June 2024}
    \resumeSubheading
      {Microsoft Certified: Azure Cosmos DB Developer Specialty}{}
      {Certification Number: 9EDA42-B345EA}{Sept 2023}
    \resumeSubheading
    ...
    \resumeSubheading
      ...
      {Bachelor of Science, Psychology;  GPA: 3.47}{Aug 2009 - May 2013}
  \resumeSubHeadingListEnd
