...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Planet DDS}{Akron, OH}
      {Software Engineer}{[Acquired] Jan 2021 - Present}
      \resumeItemListStart
        ...
        \resumeItem{Continuous Integration}
          {Created and maintained Azure Pipelines to automate builds artifacts for deployments of core web applications to staging environments.}
        \resumeItem{Private Package Feeds}
          {Refactored code and developed private NPM and Nuget packages that could be consumed by different projects and teams.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Native Bridge Service}
          {Designed and implemented the desktop service to enable the company's legacy desktop software to interoperate with their newest cloud software, including the development of three browser extensions (Chrome, Firefox, Microsoft Edge).}
      \resumeItemListEnd
